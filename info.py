...
URL = "https://lmsearchbot-e6bae3acfbcb.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lmsearchbot-e6bae3acfbcb.herokuapp.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lmsearchbot-e6bae3acfbcb.herokuapp.com".format(FQDN)
else:
    URL = "https://lmsearchbot-e6bae3acfbcb.herokuapp.com".format(FQDN)
