...
URL = "https://lmsearchbot-be7c89ab46f0.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lmsearchbot-be7c89ab46f0.herokuapp.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lmsearchbot-be7c89ab46f0.herokuapp.com".format(FQDN)
else:
    URL = "https://lmsearchbot-be7c89ab46f0.herokuapp.com".format(FQDN)
